        ...
        static void Input()
        {
            do
            {
                ...
                while (costumeP1 == true && costumesMenu == true)
                {
                    ...
                    switch (consoleKey)
                    {
                        case ConsoleKey.B: { costumeP1 = false; costumeP2 = true; SamplePlayer2(); break; }//Mở màn hình 
                ...
                while (costumeP2 == true && costumesMenu == true)
                {
                    ...
                    switch (consoleKey)
                    {
                        case ConsoleKey.A: { costumeP1 = true; costumeP2 = false; SamplePlayer1(); break; }//Mở màn hình P1
                        case ConsoleKey.Escape: { costumesMenu = false; MainMenu(); break; }
                        //Chọn màu cho Player1
