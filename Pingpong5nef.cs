...
namespace PingPong5
{
    internal class Program
    {
        ...
        //Menu Costumes
        static bool a = true;//Chọn màu cho Player1
        static bool b = false;//Chọn màu cho Player2
        static bool c = false;//Chọn màu cho Ball
        ...
        static void Input()
        {
            do
            {
                ...
                //Khi ở Costumes Menu
                #region SelectColor
                while (a == true && costumesMenu == true)
                {
                    consoleKey = Console.ReadKey(true).Key;
                    switch (consoleKey)
                    {
                ...
                while (b == true && costumesMenu == true)
                {
                    consoleKey = Console.ReadKey(true).Key;
                    switch (consoleKey)
                    {
                ...
                while (c == true && costumesMenu == true)
                {
                    consoleKey = Console.ReadKey(true).Key;
                    switch (consoleKey)
                    {
